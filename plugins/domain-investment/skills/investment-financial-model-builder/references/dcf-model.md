...
Provide enterprise value, equity value, per-share value, WACC, terminal assumptions, forecast-period UFCF, terminal-value share of enterprise value, sensitivity range, bridge adjustments, and failed checks. investment-valuation-returns owns method weighting and price-target interpretation.
