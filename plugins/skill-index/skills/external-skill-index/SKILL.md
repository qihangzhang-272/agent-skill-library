...
- You need to decide whether an external skill should stay as an index or be promoted into a locally maintained Skill.
- You are preparing, outside a stable Run, to replace an external capability such as `baoyu-skills`, GSAP skills, Impeccable, Humanizer-zh, or OSS investment scoring with a local Skill.
...
4. Outside the Run, import, fork, wrap, or absorb it into a local Skill, then draft its quality contract and trial it in isolation.
