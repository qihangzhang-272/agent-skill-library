---
name: qihang-financial-model-builder
description: Use when Qihang explicitly needs an auditable XLSX financial model, three-statement forecast, DCF or LBO workbook, model sensitivity, or spreadsheet audit before valuation. Do not use for narrative-only valuation or when verified historical inputs and assumptions are missing.
---
...
6. Hand off model outputs and limitations to `qihang-valuation-returns`; do not turn the workbook into a price target or investment verdict here.
