...
## 链路（9 瓦技能，顺序执行）
research object → domain-investment:investment-research → domain-investment:investment-ai-product-judgment →
domain-investment:investment-competitive-landscape → domain-investment:investment-unit-economics → domain-investment:investment-scorecard →
domain-investment:investment-valuation-returns → domain-investment:investment-dd → domain-investment:investment-thesis-tracking →
domain-investment:investment-ic-memo-writer → optional visual report（用 domain-investment:investment-visual-report 技能）
