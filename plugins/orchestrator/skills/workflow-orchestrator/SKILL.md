...
| 用户意图 | 链定义 |
| --- | --- |
| 公众号选题、agent-reach 搜索、编辑判断、公众号深度写作、启航统一排版、视觉生产、HTML 预览与草稿箱发布 | `references/chains/wechat-writing.md` |
